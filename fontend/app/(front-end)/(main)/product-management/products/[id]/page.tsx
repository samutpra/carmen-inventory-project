    ...
    const saveConversions = async () => {
      try {
        const response = await fetch(
          `/api/products/${product.id}/conversions`,
          {
            method: 'PUT',
            headers: { 'Content-Type': 'application/json' },
      ...
      <>
        <Tabs defaultValue='basic'>
          <TabsList>
            ...
            <TabsTrigger value='orderConversions'>
              Order Conversions
            </TabsTrigger>
            <TabsTrigger value='recipeConversions'>
              Recipe Conversions
            </TabsTrigger>
            <TabsTrigger value='countingConversions'>
          ...
          <TabsContent value='pricing'>
            ...
            <p>
              <strong>Standard Cost:</strong> {product.standardCost}{' '}
              {product.currency}
            </p>
            <p>
            ...
            <p>
              <strong>Price Deviation Limit:</strong>{' '}
              {product.priceDeviationLimit}%
            </p>
            <p>
              <strong>Quantity Deviation Limit:</strong>{' '}
              {product.quantityDeviationLimit}%
            </p>
          </TabsContent>
          <TabsContent value='inventory'>
            <h2 className='text-xl font-semibold mb-2'>Inventory Management</h2>
            <p>
              <strong>Primary Inventory Unit:</strong>{' '}
              {product.primaryInventoryUnitId}
            </p>
            <p>
            ...
            <Button
              className='mt-2'
              onClick={() => handleAddConversion('INVENTORY')}
            >
          ...
          <TabsContent value='usage'>
            ...
            <p>
              <strong>Is Ingredient:</strong>{' '}
              {product.isIngredient ? 'Yes' : 'No'}
            </p>
          </TabsContent>
          <TabsContent value='conversions'>
            ...
            <div className='mt-2 space-x-2'>
              <Button onClick={() => handleAddConversion('INVENTORY')}>
                Add Inventory Unit
              </Button>
              <Button onClick={() => handleAddConversion('ORDER')}>
                Add Order Unit
              </Button>
              <Button onClick={() => handleAddConversion('RECIPE')}>
                Add Recipe Unit
              </Button>
              <Button onClick={() => handleAddConversion('COUNTING')}>
                Add Counting Unit
              </Button>
            </div>
          </TabsContent>
          <TabsContent value='orderConversions'>
            ...
            <Button
              className='mt-2'
              onClick={() => handleAddConversion('ORDER')}
            >
              <PlusIcon className='h-4 w-4 mr-2' />
          ...
          <TabsContent value='recipeConversions'>
            ...
            <Button
              className='mt-2'
              onClick={() => handleAddConversion('RECIPE')}
            >
              <PlusIcon className='h-4 w-4 mr-2' />
          ...
          <TabsContent value='countingConversions'>
            ...
            <Button
              className='mt-2'
              onClick={() => handleAddConversion('COUNTING')}
            >
              <PlusIcon className='h-4 w-4 mr-2' />
