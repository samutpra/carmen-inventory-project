        ...
        <TabsContent value="basic">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              ...
              <p><strong>Status:</strong> <Badge variant={product.isActive ? "secondary" : "destructive"}>{product.isActive ? 'Active' : 'Inactive'}</Badge></p>
            </div>
            <div>
            ...
            <TableBody>
              {product.unitConversions.map((conversion) => (
                <TableRow key={conversion.id}>
                  ...
                  <TableCell>
                    <Button variant="ghost" size="icon" onClick={() => handleEditConversion(conversion.id, 'fromUnit', conversion.fromUnit)}>
